...
def test_auction_run_uses_fact_store_and_existing_audit_tables(tmp_path):
    snapshot = {
        ...
        "ts_code": "000001.SZ",
        "stock_name": "平安银行",
        "snapshot_time": "2026-09-04T09:25:00+08:00",
        "checkpoint_time": "09:25:00",
        "match_price": 10.0,
        "matched_volume": 1000,
        "matched_amount": 10_000,
        ...
        "source_data_time": "2026-09-04T09:25:00+08:00",
        "checkpoint_lag_ms": 0,
    ...
    written = persist_auction_run(
        ...
        quality_status="PARTIAL",
        quality_checks=[
            {"name": "stock_completion_rate", "actual": 1.0, "threshold": 0.95, "passed": True}
        ],
        conflicts=[],
        failures=[],
        fact_store=store,
